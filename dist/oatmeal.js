...
'use strict';
var bake, bakeCookies, cookie, cookieJar, decode, encode, get, getSource, munch, munchMunch, oatmeal, refillJar, serialize, set, setSource, source,
...
get = function(name) {
  return (cookieJar != null ? cookieJar : cookieJar = bakeCookies(getSource()))[name];
};
...
refillJar = function() {
  if (getSource() !== null) {
    return cookieJar = bakeCookies(getSource());
  }
};
